...
class GameConfig():
    ...
    _config = {
        ...
        'background.speed.bg.clouds.big.min': 10,
        'background.speed.bg.clouds.big.max': 80,
        ...
        'level.velocity.correction.epsilon': 0.08,
        ...
        'level.collision.detection.correction.left': 1,
        'level.collision.detection.correction.right': 1,
        ...
        'barrier.cannon.right.correction': (-8, -1),
        ...
        'camera.text.color': Colors.GREEN_LIGHT,
        'camera.line.color': Colors.GREEN_LIGHT,
