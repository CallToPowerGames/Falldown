...
class GameConfig():
    ...
    _config = {
        ...
        'background.speed.bg.clouds.big.min': 30,
        'background.speed.bg.clouds.big.max': 40,
        'background.speed.bg.clouds.mid.min': 20,
        'background.speed.bg.clouds.mid.max': 30,
        'background.speed.bg.clouds.small.min': 10,
        'background.speed.bg.clouds.small.max': 20,
        ...
        'background.offset.factor.bg.image': 5 / 10,
